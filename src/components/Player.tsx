...
export const Player = () => {
  ...
  }, [skipToPreviousTrack, isShuffled, selectedAudioId]);

  const handleSkipForward = useCallback(() => {
    skipToNextTrack();
  }, [skipToNextTrack, selectedAudioId]);

  const handleShuffle = useCallback(() => {
    toggleShuffle();
  }, [toggleShuffle, isShuffled, audioSources.length]);
    ...
    <div className="w-full flex justify-center">
      <div className="w-full max-w-[37rem]">
        <div className="flex items-center justify-center gap-6 mb-2">
          ...
          <button
            className="bg-white text-black rounded-full p-3 md:p-2 hover:scale-105 hover:ring-2 hover:ring-white/20 focus-visible:ring-2 focus-visible:ring-white transition-all duration-200"
