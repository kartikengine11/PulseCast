    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://no-bbc.sentry.io/issues/?project=4509631558057984">Issues Page</a>.
